...
export const COMMUNES = {
  "Adrar":["Adrar","Reggane","Timimoun","Aoulef","Fenoughil","Zaouiet Kounta"],
  "Chlef":["Chlef","Ténès","Ouled Ben Abdelkader","Oued Fodda","Chettia","Boukadir"],
  "Laghouat":["Laghouat","Ksar El Boukhari","Aïn Madhi","Hassi Delaa","Brida","Sidi Makhlouf"],
  "Oum El Bouaghi":["Oum El Bouaghi","Aïn Beïda","Aïn Fakroun","Aïn M'lila","Souk Naamane","Fkirina"],
  "Batna":["Batna","Timgad","N'Gaous","Aïn Yagout","Arris","Tazoult"],
  "Béjaïa":["Béjaïa","Akbou","Amizour","Kherrata","Tichy","Aokas","Seddouk","El Kseur"],
  "Biskra":["Biskra","Tolga","El Kantara","Aïn Zaatout","Sidi Okba","Ourlal"],
  "Béchar":["Béchar","Kenadsa","Taghit","Boukaïs","Beni Ounif","Erg Ferradj"],
  "Blida":["Blida","Boufarik","El Affroun","Mouzaïa","Bouinan","Bougara","Larbaâ","Chréa"],
  "Bouira":["Bouira","Lakhdaria","Sour El Ghozlane","Aïn Bessem","Bordj Okhriss","El Adjiba"],
  "Tamanrasset":["Tamanrasset","Tazrouk","Abalessa","Idlès","Tin Zaouatine","In Salah"],
  "Tébessa":["Tébessa","El Aouinet","Bekkaria","El Meridj","Cheria","Ouenza"],
  "Tlemcen":["Tlemcen","Maghnia","Remchi","Ghazaouet","Chetouane","Nedroma","Mansourah"],
  "Tiaret":["Tiaret","Mahdia","Sougueur","Frenda","Ksar Chellala","Dahmouni"],
  "Djelfa":["Djelfa","Messaâd","Aïn Oussara","Hassi Bahbah","Sidi Ladjel","El Idrissia"],
  "Jijel":["Jijel","El Milia","Taher","Ouled Rabah","Sidi Abdelaziz","Ziama Mansouriah"],
  "Saïda":["Saïda","Aïn El Hadjar","Sidi Boubekeur","Doui Thabet","El Hassasna","Ouled Brahim"],
  "Skikda":["Skikda","Azzaba","Collo","El Harrouch","Kerkera","Tamalous"],
  "Sidi Bel Abbès":["Sidi Bel Abbès","Télagh","Moulay Slissen","Sidi Ali Benyoub","Aïn Thrid"],
  "Annaba":["Annaba","El Hadjar","Seraïdi","Berrahal","Chetaïbi","El Bouni"],
  "Guelma":["Guelma","Aïn Makhlouf","Hammam Debagh","Bouchegouf","Drean","Nador"],
  "Médéa":["Médéa","Berrouaghia","Ksar El Boukhari","Souagui","Tablat","Ouzera"],
  "Mostaganem":["Mostaganem","Hassi Mameche","Aïn Nouïssy","Ouled Boughalem","Sidi Ali"],
  "M'Sila":["M'Sila","Bou Saâda","Aïn El Hadjel","Sidi Aïssa","Magra","Hammam Dalaa"],
  "Mascara":["Mascara","Sig","Mohammadia","Ghriss","Tighennif","Froha"],
  "Ouargla":["Ouargla","N'Goussa","Touggourt","Hassi Messaoud","El Borma"],
  "El Bayadh":["El Bayadh","Boualem","Brezina","Rogassa","Sidi Slimane","Chellala"],
  "Illizi":["Illizi","Djanet","In Amenas","Debdeb","Bordj Omar Driss"],
  "Bordj Bou Arréridj":["Bordj Bou Arréridj","Ras El Oued","Bordj Ghedir","El Annasser","Mansoura","Aïn Taghrout"],
  "Boumerdès":["Boumerdès","Boudouaou","Bordj Menaïel","Dellys","Thenia","Corso","Ouled Moussa"],
  "El Tarf":["El Tarf","Besbes","El Kala","Chihani","Dréan","Le Tarf"],
  "Tindouf":["Tindouf","Oum Ladjoul","Aïn Khier"],
  "Tissemsilt":["Tissemsilt","Lardjem","Khemisti","Theniet El Had","Bordj Bounaama"],
  "El Oued":["El Oued","El M'Ghair","Djamaa","Reguiba","Hassi Khalifa","Magrane"],
  "Khenchela":["Khenchela","Kais","Chetma","Ouled Rechache","El Mahmal"],
  "Souk Ahras":["Souk Ahras","Sedrata","M'daourouch","Hanencha","Taoura","Zaarouria"],
  "Tipaza":["Tipaza","Cherchell","Douaouda","Bou Ismail","Ahmer El Aïn","Gouraya"],
  "Mila":["Mila","Chelghoum Laïd","Ferdjioua","Ouled Sidi El Arbi","Tadjenanet"],
  "Aïn Defla":["Aïn Defla","Khemis Miliana","El Attaf","Bordj El Emir","Tadmaït","Rouina"],
  "Naâma":["Naâma","Mécheria","Aïn Sefra","Sfissifa","Asla","El Biodh"],
  "Aïn Témouchent":["Aïn Témouchent","Béni Saf","Hammam Bouhadjar","Chaabet El Ham","Sidi Ben Sahbi"],
  "Relizane":["Relizane","Oued Rhiou","Zemmoura","Bendaoud","Mazouna","Yellel"],
  "Timimoun":["Timimoun","Adrar","Aougrout","Tinerkouk","Meteber"],
  "Bordj Badji Mokhtar":["Bordj Badji Mokhtar","Timiaouine"],
  "Ouled Djellal":["Ouled Djellal","Sidi Khaled","Ras El Miaad","Chaïba","Doucen"],
  "Béni Abbès":["Béni Abbès","Ouled Khodeïr","Tamtert","El Ouata","Kerzaz"],
  "In Salah":["In Salah","Foggaret Ezzoua","In Ghar","Ain Salah"],
  "In Guezzam":["In Guezzam","Tin Zouaten"],
  "Touggourt":["Touggourt","Témacine","Megarine","Nezla","Tebesbest"],
  "Djanet":["Djanet","Bordj El Haouès"],
  "El M'Ghair":["El M'Ghair","Sidi Amrane","Tendla","Oum Tiour"],
  "El Meniaa":["El Meniaa","Hassi Gara","Belali"],
}
